...
class TimeSlot(BaseModel):
    ...
    phone_number: str = Field(None, description="Phone number of the participant")
    start_time: str = Field(..., description="Start time of the slot")
    end_time: str = Field(..., description="End time of the slot")
